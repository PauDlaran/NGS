...
class IHM_NGS(customtkinter.CTk):
    ...
    def __init__(self):
        ...
        self.qr_code_path = "/home/polo/Desktop/NGS/IHM_NGS/QRCODE/"
    ...
    def generateQrCode(self, data, event=0):
        ...
        if data != None:
            file_path = "/home/polo/Desktop/NGS/IHM_NGS/QRCODE/"
    ...
    def take_photo(self, event=0) : #TODO tester
        ...
        if found_window :
            ...
            print('path=/home/polo/Desktop/NGS/IHM_NGS/Prelevement '+str(self.n_prelev.get())+'/Photo_Sysm@p_'+str(self.num_photo)+'.jpg')
            screenshot.save('/home/polo/Desktop/NGS/IHM_NGS/Prelevement '+str(self.n_prelev.get())+'/Photo_Sysm@p_'+str(self.num_photo)+'.jpg')

        self.nom_image.append('/home/polo/Desktop/NGS/IHM_NGS/Prelevement '+str(self.n_prelev.get())+'/Photo_Sysm@p_'+str(self.num_photo)+'.jpg')
        self.num_photo+=1 
    ...
    def exporter(self, event=0):
        ...
        if self.dernier_bouton_clique == "Stockage1":
            pdf_path = "/home/polo/Desktop/NGS/IHM_NGS/Stockages/" + str(self.qr_code1_label.cget("text")) + ".pdf"
            csv_path = "/home/polo/Desktop/NGS/IHM_NGS/Stockages/" + str(self.qr_code1_label.cget("text")) + ".csv"
            qr_code_label = self.qr_code1_label
        if self.dernier_bouton_clique == "Stockage2":
            pdf_path = "/home/polo/Desktop/NGS/IHM_NGS/Stockages/" + str(self.qr_code2_label.cget("text")) + ".pdf"
            csv_path = "/home/polo/Desktop/NGS/IHM_NGS/Stockages/" + str(self.qr_code2_label.cget("text")) + ".csv"
            qr_code_label = self.qr_code2_label
        if self.dernier_bouton_clique == "Stockage3 ":
            pdf_path = "/home/polo/Desktop/NGS/IHM_NGS/Stockages/" + str(self.qr_code3_label.cget("text")) + ".pdf"    
            csv_path = "/home/polo/Desktop/NGS/IHM_NGS/Stockages/" + str(self.qr_code3_label.cget("text")) + ".csv"          
    ...
    def dossier_photo(self, event=0):
        self.filename = filedialog.askdirectory(
                    ...
                    initialdir='/home/polo/Desktop/NGS/IHM_NGS/Prelevement ' + str(self.n_prelev.get()) + '/',
                    )
