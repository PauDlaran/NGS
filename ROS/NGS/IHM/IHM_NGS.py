...
class IHM_NGS(customtkinter.CTk):
    ...
    def __init__(self):
        ...
        #self.subscriber = rospy.Subscriber('INFO_ARDUINO', String, self.callback)
    ...
    def exporter(self, event=0):
        pdf_path = "/home/roman/Bureau/NGS/Rapports Sysm@p/Rapport du prélèvement n°"+str(self.entry_numéro_prelevement.cget("text"))+ " de la mission " + self.entry_numéro_mission_prepa.get() + ".pdf"
        ...
        title = "Rapport de traçabilité du prélèvement N° " + str(self.entry_numéro_prelevement.cget("text"))+ " de la mission " + self.entry_numéro_mission_prepa.get()
        ...
        if self.Type_extract == "csv":
            pdf.save()
            csv_path = "/home/roman/Bureau/NGS/Rapports Sysm@p/Rapport du prélèvement n°"+str(self.entry_numéro_prelevement.cget("text"))+ " de la mission " + self.entry_numéro_mission_prepa.get() + ".csv"
